...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('support/css/icomoon.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/transitions.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/pogo-slider.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/YouTubePopUp.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/scrollbar.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/jgallery.min.css') }}">
    <link rel="stylesheet" href="{{ asset('support/css/magnific-popup.css') }}">
